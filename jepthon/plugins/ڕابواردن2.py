...
async def _(event):
    "animation command"
    event = await edit_or_reply(event, "زەوی)
    deq = deque(list("🌏🌍🌎🌎🌍🌏🌍🌎"))
    for _ in range(48):
        await asyncio.sleep(0.2)
        await event.edit("".join(deq))
...
@jepiq.ar_cmd(
    pattern="مانگ$",
    command=("مانگ", plugin_category),
    info={
        "فەرمان": "ئەمە بابەتێکی سەرگەرمییە، خۆت تاقی بکەوە",
        "بەکارهێنان": "{tr}مانگ",
    },
)
async def _(event):
...
@jepiq.ar_cmd(
    pattern="مانگەکان$",
    command=("مانگەکان", plugin_category),
    info={
        "فەرمان": "ئەمە بابەتێکی سەرگەرمییە، خۆت تاقی بکەرەوە",
        "بەکارهێنان": "{tr}مانگەکان",
    },
)
async def _(event):
    "animation command"
    event = await edit_or_reply(event, "مانگەکان")
    animation_interval = 0.2
    animation_ttl = range(101)
    await event.edit("مانگەکان..")
    animation_chars = [
        "🌗🌗🌗🌗🌗\n🌓🌓🌓🌓🌓\n🌗🌗🌗🌗🌗\n🌓🌓🌓🌓🌓\n🌗🌗🌗🌗🌗",
        "🌘🌘🌘🌘🌘\n🌔🌔🌔🌔🌔\n🌘🌘🌘🌘🌘\n🌔🌔🌔🌔🌔\n🌘🌘🌘🌘🌘",
        "🌑🌑🌑🌑🌑\n🌕🌕🌕🌕🌕\n🌑🌑🌑🌑🌑\n🌕🌕🌕🌕🌕\n🌑🌑🌑🌑🌑",
